...
contains example codes that can be compiled with the CMake. More details
on how to do this are given below in the *Getting Started* section.
...
.. attention::
  ...
  are interested in the basic structure of a mesh_topology
  ...
  *specialization* subdirectory of this tutorial (The complete source
  code is in the *flecsi/tutorial/specialization* subdirectory of the
  main project.)

Requirements
************

This tutorial assumes that you have successfully installed FleCSI
