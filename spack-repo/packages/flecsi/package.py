...
class Flecsi(CMakePackage):
    ...
    depends_on('legion@ctrl-rep-4+shared+mpi+hdf5 build_type=Debug', when='backend=legion +debug_backend +hdf5')
    depends_on('legion@ctrl-rep-4+shared+mpi build_type=Debug', when='backend=legion +debug_backend ~hdf5')
    depends_on('legion@ctrl-rep-4+shared+mpi+hdf5 build_type=Release', when='backend=legion ~debug_backend +hdf5')
    depends_on('legion@ctrl-rep-4+shared+mpi build_type=Release', when='backend=legion ~debug_backend ~hdf5')
