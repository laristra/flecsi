...
class Flecsi(CMakePackage):
    ...
    depends_on('legion@ctrl-rep-3 +shared +mpi build_type=Release +hdf5', when='backend=legion +hdf5')
    depends_on('legion@ctrl-rep-3 +shared +mpi build_type=Release', when='backend=legion ~hdf5')
