...
inline const char * operator*(cp control_point) {
  switch(control_point) {
    case cp::one: return "Control Point 1";
    case cp::two: return "Control Point 2";
    case cp::three: return "Control Point 3";
    case cp::four: return "Control Point 4";
  }
...
struct control_policy {
  ...
  using cycle = flecsi::cycle<step_control,
        control_point<cp::two>,
        control_point<cp::three>
  >;

  using control_points =
    std::tuple<
      control_point<cp::one>,
      cycle,
      control_point<cp::four>
    >;
