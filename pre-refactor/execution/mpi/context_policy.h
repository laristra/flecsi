...
struct mpi_context_policy_t {
  ...
  void register_field_metadata(const field_id_t fid,
    ...
    register_field_metadata_<T>(metadata,
      fid,
      coloring_info,
      index_coloring,
      compact_origin_lengs,
      compact_origin_disps,
      compact_target_lengs,
  ...
  void register_sparse_field_metadata(const field_id_t fid,
    ...
    register_field_metadata_<T>(metadata,
      ...
      coloring_info,
      index_coloring,
      metadata.compact_origin_lengs,
      metadata.compact_origin_disps,
      metadata.compact_target_lengs,
      metadata.compact_target_disps);
...
// during tutorial runs). Consider changing this to use clog
  ...
  void register_sparse_field_data(field_id_t fid,
    ...
    size_t exclusive_reserve) {
    // TODO: VERSIONS
    sparse_field_data.emplace(fid,
      sparse_field_data_t(type_size,
