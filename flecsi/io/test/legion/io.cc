...
io_sanity(int argc, char ** argv) {
  ...
  LogicalPartition file_checkpoint_lp_input_1 =
    runtime->get_logical_partition(ctx, input_lr_1, file_ip);
  LogicalPartition file_checkpoint_lp_input_2 =
    runtime->get_logical_partition(ctx, input_lr_2, file_ip);

  LogicalPartition file_recover_lp_output_1 =
    runtime->get_logical_partition(ctx, output_lr_1, file_ip);
