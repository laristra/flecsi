...
#ifndef flecsi_supplemental_tikz_h
#define flecsi_supplemental_tikz_h

//-----------------------------------------------------------------------------//
//! @file
//! @date Initial file creation: Jun 10, 2017
//-----------------------------------------------------------------------------//
...
private:
  ...
  )
  {
    ...
    if(fill) {
      stream << "," << "fill=" << std::get<2>(palette[color]);
    } // if
...
#endif // flecsi_supplemental_tikz_h
