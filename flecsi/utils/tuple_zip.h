...
// user includes
#include "flecsi/utils/detail/tuple_zip.h"
...
decltype(auto) tuple_tie(Tup1 && t1, Tup2 && t2)
{
  ...
  return detail::tuple_tie_helper(std::forward<Tup1>(t1),
      std::forward<Tup2>(t2), typename detail::gens<num_args2>::type());
}
...
decltype(auto) tuple_zip(Tup1 && t1, Tup2 && t2)
{
  ...
  return detail::tuple_zip_helper(std::forward<Tup1>(t1),
      std::forward<Tup2>(t2), typename detail::gens<num_args2>::type());
}
