...
struct client_registration_wrapper_u<
  ...
  struct entity_walker_t
    ...
    void handle_type() {
      ...
      const size_t field_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_entity_data").hash(),
          INDEX_TYPE::value>();
      ...
      const size_t id_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_entity_id").hash(),
          INDEX_TYPE::value>();
  ...
  struct connectivity_walker_u
    ...
    void handle_type() {
      ...
      const size_t index_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_adjacency_index").hash(),
          INDEX_TYPE::value>();
      ...
      const size_t offset_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_adjacency_offset").hash(),
          INDEX_TYPE::value>();
  ...
  struct index_subspaces_walker_u
    ...
    void handle_type() {
      ...
      const size_t field_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_index_subspace_index")
              .hash(),
          INDEX_SUBSPACE_TYPE::value>();
  ...
  struct entity_walker_t
    ...
    void handle_type() {
      ...
      const size_t active_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_active_entity_data")
              .hash(),
          INDEX_TYPE::value>();
      ...
      const size_t migrate_key = utils::hash::client_internal_field_hash<
          utils::const_string_t("flecsi_internal_migrate_entity_data")
              .hash(),
          INDEX_TYPE::value>();
