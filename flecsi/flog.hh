...
#define flog(severity)                                                         \
  /* MACRO IMPLEMENTATION */                                                   \
                                                                               \
  true &&                                                                      \
    flecsi::flog::severity##_log_message_t(__FILE__, __LINE__, false).stream()
...
#define flog_devel(severity)                                                   \
  /* MACRO IMPLEMENTATION */                                                   \
                                                                               \
  true &&                                                                      \
    flecsi::flog::severity##_log_message_t(__FILE__, __LINE__, true).stream()
