...
driver(int argc, char ** argv) {
  ...
  auto handle =
    flecsi_get_handle(ch, name_space, cell_ID, size_t, dense, CELL_ID);
  auto test_handle =
    flecsi_get_handle(ch, name_space, test, double, dense, CELL_ID);
  auto vert_handle =
    flecsi_get_handle(ch, name_space, vert_ID, size_t, dense, VERT_ID);
  auto vtest_handle =
...
TEST(unordered_ispaces, testname) {} // TEST
