...
#ifndef flecsi_topology_serial_topology_set_storage_policy_h
#define flecsi_topology_serial_topology_set_storage_policy_h
...
struct serial_set_topology_storage_policy_t
{
  ...
  serial_set_topology_storage_policy_t()
  {
