...
#include <flecsi/topology/tree/tree_geometry.h>
#include <flecsi/topology/tree/tree_hash_table.h>
#include <flecsi/topology/tree/tree_storage.h>
#include <flecsi/topology/tree/tree_types.h>
...
class tree_topology_u : public tree_topology_base_u<tree_storage_u<TREE_TYPE>>
{

public:
  using Policy = TREE_TYPE;

  // tree storage type definition
  using storage_t = tree_storage_u<Policy>;
  // tree topology base definition
  using base_t = tree_topology_base_u<storage_t>;
  // entity ID type
  using id_t = utils::id_t;
  // offset type use by connectivities to give offsets and counts
  using offset_t = utils::offset_t;

  using type_identifier_t = tree_topology_u;
  ...
  using key_int_t = typename Policy::filling_curve_int_t;
  // ------- Space filling curve
  ...
  tree_topology_u(const tree_topology_u & s) : base_t(s) {}
  ...
  friend std::ostream & operator<<(std::ostream & os,
    const tree_topology_u<TREE_POLICY> & t);
...
template<class TREE_TYPE>
std::ostream &
operator<<(std::ostream & os, const tree_topology_u<TREE_TYPE> & t) {
