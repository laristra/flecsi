...
struct unstruct_mesh_traits_t {
  ...
  enum class attachment_site_t : size_t { vertices, edges, faces, cells };

  //! \brief state attributes
  enum class state_attribute_t : bitfield_t::field_type_t { persistent = 0 };
...
//=============================================================================
template <>
std::pair<size_t, size_t> unstruct_cell_t<2>::create_entities(
    size_t dim, id_t * e, id_t * v, size_t vertex_count)
{
  e[0] = v[0];
  e[1] = v[1];
...
//=============================================================================
template <>
std::pair<size_t, size_t> unstruct_cell_t<3>::create_entities(
    size_t dim, id_t * e, id_t * v, size_t vertex_count)
{
  // want edges
  if (dim == 1) {
...
struct unstruct_mesh_types_t {
  ...
  class vertex_t : public mesh_entity<0>
  {
   public:
    ...
    vertex_t(const point_t & coordinates, state_t * state)
